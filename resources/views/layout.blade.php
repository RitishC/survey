      ...
      <div class="container">
          <div class="row" style="padding-top:10px;">
              <div class="center-align">
                <a class="btn blue waves-effect waves-light lighten-1 white-text" href="/public"> Startpagina </a>
                  @if(Auth::check())
                  ...
                  @else
                    <a class="btn-flat waves-effect waves-light darken-1 white black-text" href="/login"> Inloggen </a>
                    <a class="btn-flat waves-effect waves-light darken-1 white black-text" href="/register"> Registreren </a>
                  @endif
              </div>
          </div>
          <div class="row">
