...
@section('content')
  <div class="card">
      ...
      <br/>
      <!--<a href='view/{{$survey->id}}'>Survey afnemen</a> --> <a href="{{$survey->id}}/edit" >Wijzig survey</a> | <a href="/survey/answers/{{$survey->id}}" style="text-decoration:underline; color: blue;">Bekijk de resultaten</a> <a href="#doDelete" style="float:right;" class="modal-trigger red-text">Verwijder survey</a>
      </br></br>
